...
4. You resolved exactly one completed-group state ID from the selected project. If there is no completed state or more than one candidate, keep the current state and report the candidates.
