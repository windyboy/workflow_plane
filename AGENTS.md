...
- For cross-agent review explicitly requested by the user, the primary agent is the only Plane writer and owns implementation plus verification. Never trigger a reviewer automatically.
